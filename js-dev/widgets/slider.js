$.widget("metro.slider", $.metro.plugin, {
    ...
    _placeMarker: function (value) {
        var size, size2, o = this.options, colorParts, colorIndex = 0, colorDelta,
    ...
    _showBuffer: function(value){
        var size, oldSize, o = this.options,
    ...
    _setOption: function(key, value){
        ...
        if (key === 'onBufferChange') {
            this.options.onBufferChange = this._checkEventFunc(this.options.onBufferChange);
        } else if (key === 'onStartChange') {
            this.options.onStartChange = this._checkEventFunc(this.options.onStartChange);
