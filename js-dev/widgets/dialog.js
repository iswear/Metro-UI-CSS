$.widget( "metro.dialog" , $.metro.plugin, {
    ...
    _setOption: function ( key, value ) {
        ...
        if (key === 'onDialogOpen') {
            this.options.onDialogOpen = this._checkEventFunc(this.options.onDialogOpen);
        } else if (key === 'onDialogClose')
        if (key === 'onDialogClose') {
            this.options.onDialogClose = this._checkEventFunc(this.options.onDialogClose);
        }
    }
});
