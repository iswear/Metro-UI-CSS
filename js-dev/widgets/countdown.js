$.widget( "metro.countdown" , $.metro.plugin, {
    ...
    _create: function () {
        ...
        this._super();
        this.element.data('countdown', this);
    },
    ...
    _setOption: function ( key, value ) {
        ...
        if (key === 'onTick') {
            this.options.onTick = this._checkEventFunc(this.options.onTick);
        } else if (key === 'onStop') {
            this.options.onStop = this._checkEventFunc(this.options.onStop);
        }
    }
});
