$.widget("metro.wizard", $.metro.plugin, {
    ...
    _setOption: function(key, value){
        ...
        if (key === 'onCancel') {
            ...
            this.options.onHelp = this._checkEventFunc(this.options.onHelp);
        } else if (key === 'onPrior') {
            this.options.onPrior = this._checkEventFunc(this.options.onPrior);
        } else if (key === 'onNext') {
            this.options.onNext = this._checkEventFunc(this.options.onNext);
        } else if (key === 'onFinish') {
            this.options.onFinish = this._checkEventFunc(this.options.onFinish);
        } else if (key === 'onPage') {
            this.options.onPage = this._checkEventFunc(this.options.onPage);
        } else if (key === 'onStepClick') {
            this.options.onStepClick = this._checkEventFunc(this.options.onStepClick);
        }
    }
});
