$.widget( "metro.validator" , $.metro.plugin, {
    ...
    _setOption: function ( key, value ) {
        ...
        if (key === 'onBeforeSubmit') {
            this.options.onBeforeSubmit = this._checkEventFunc(this.options.onBeforeSubmit);
        } else if (key === 'onErrorInput') {
            this.options.onErrorInput = this._checkEventFunc(this.options.onErrorInput);
        } else if (key === 'onSubmit') {
            this.options.onSubmit = this._checkEventFunc(this.options.onSubmit);
        }
    }
});
